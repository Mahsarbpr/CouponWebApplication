...
<div class="container id="main">
          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
				...
				<li class="active"><a href="CWAupdatecoupon.jsp">Update Coupon</a></li>
  ...
  <form role="form" name="updateform" action="updateCouponServlet">
  ...
  <br></br>
    Discount amount: <input type="text" class="form-control" id="in" name="in" value="${da}">
  <br></br>
	Coupon Type: <input type="text" class="form-control" id="in" name="in" value="${ct}">
  <br></br>
    Item ID: <input type="text" class="form-control" id="in" name="in" value="${ii}">
  <br></br>
